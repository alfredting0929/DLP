    ...
    def inpainting(self, image, mask_b, i):
        ...
        with torch.no_grad():
            ...
            for step in range(self.total_iter):
                ...
                # Ensure original non-masked tokens remain the same, otherwise the performance will be bad
...
#TODO3 step1-2: modify the path, MVTM parameters
    parser.add_argument('--load', type=str, default='', help='load ckpt')
    ...
    #MVTM parameter
    parser.add_argument('--sweet-spot', type=int, default=None, help='sweet spot: the best step in total iteration')
    parser.add_argument('--total-iter', type=int, default=8, help='total step for mask scheduling')
    parser.add_argument('--mask-func', type=str, default=None, help='mask scheduling function')
    ...
    i=0
    for image, mask in tqdm(zip(t.mi_ori, t.mask_ori), total=len(t.mi_ori.dataset)):
